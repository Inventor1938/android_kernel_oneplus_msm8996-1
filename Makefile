...
ARCH		?= arm64
CROSS_COMPILE	?= $(CCACHE) /home/ivankolev/citrus/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-6.x/bin/aarch64-linux-android-
...
CORTEX_OPTS	+= -mcpu=cortex-a57
# GCC_OPTS	= $(GRAPHITE) $(EXTRA_OPTS) $(CORTEX_OPTS)
GCC_OPTS	= $(CORTEX_OPTS)
KCFLAG		= -std=gnu11
# K_CPPFLAG	= -std=c++11
